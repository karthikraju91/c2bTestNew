                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="ti-wallet m-r-5 m-l-5"></i>
...
<?php /**PATH D:\xampp\htdocs\c2bTest\resources\views/layouts/header.blade.php ENDPATH**/ ?>