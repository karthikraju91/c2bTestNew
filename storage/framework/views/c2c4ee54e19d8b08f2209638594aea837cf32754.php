...
<footer id="footer">
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo e(asset('Medicio/assets/vendor/jquery/jquery.min.js')); ?>"></script>
  <script src="<?php echo e(asset('Medicio/assets/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
  <script src="<?php echo e(asset('Medicio/assets/vendor/jquery.easing/jquery.easing.min.js')); ?>"></script>
  <script src="<?php echo e(asset('Medicio/assets/vendor/php-email-form/validate.js')); ?>"></script>
  <script src="<?php echo e(asset('Medicio/assets/vendor/waypoints/jquery.waypoints.min.js')); ?>"></script>
  <script src="<?php echo e(asset('Medicio/assets/vendor/counterup/counterup.min.js')); ?>"></script>
  <script src="<?php echo e(asset('Medicio/assets/vendor/owl.carousel/owl.carousel.min.js')); ?>"></script>
  <script src="<?php echo e(asset('Medicio/assets/vendor/venobox/venobox.min.js')); ?>"></script>
  <script src="<?php echo e(asset('Medicio/assets/vendor/aos/aos.js')); ?>"></script>

  <!-- Template Main JS File -->
  <script src="<?php echo e(asset('Medicio/assets/js/main.js')); ?>"></script>
...
</script><?php /**PATH D:\xampp\htdocs\c2bTest\resources\views/layouts/user_footer.blade.php ENDPATH**/ ?>