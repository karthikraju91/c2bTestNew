	...
	<?php else: ?>	
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="<?php echo e(asset('users/video_list')); ?>">Videos</a></li>
...
<section id="services" class="services services">
      <div class="container" data-aos="fade-up"><?php /**PATH D:\xampp\htdocs\c2bTest\resources\views/layouts/user_header.blade.php ENDPATH**/ ?>